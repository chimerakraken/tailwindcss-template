...
<body class="antialiased font-sans">
  <div class="relative min-h-screen md:flex">
    ...
    <!-- mobile menu bar -->
    <div class="bg-red-800 text-gray-100 flex justify-between md:hidden">
      <!-- logo -->
      <a href="#" class="block p-4 text-white font-bold pl-6" style="font-family: Lobster-Regular">ARPOCHI</a>
  
      <!-- mobile menu button -->
      <button class="mobile-menu-button p-4 focus:outline-none focus:bg-red-700">
    ...
    <!-- sidebar -->
    <div class="sidebar bg-gradient-to-t from-red-800 to-rose-800 text-red-100 w-64 space-y-6 py-7 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
      <!-- logo -->
      <a href="#" class="flex items-center space-x-2 px-4 pl-9">
        {{-- <h2 style="font-family: Lobster-Regular" class="pl-6 text-2xl">ARPOCHI LOGO</h4> --}}
        <img src="{{asset('img/outlined-logo.png')}}" height="160" width="160" alt="">
      </a>
      <!-- nav -->
      ...
      <nav class="text-sm subpixel-antialiased px-5 pt-4">
        ...
        <a href="" class="block py-2 px-4 rounded transition duration-200 hover:bg-rose-200 hover:text-red-600 hover:font-medium bg-rose-200 text-red-600 font-medium">
          ...
          <div x-show="open" x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition ease-in-out duration-500 sm:duration-700" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full" class="relative w-screen max-w-md" x-description="Slide-over panel, show/hide based on slide-over state.">
            ...
            <div class="h-full flex flex-col pb-6 bg-white shadow-xl overflow-y-scroll">
              {{-- <div class="p-5 sm:px-6 min-h-24 bg-red-800 static" > --}}
                <div class="p-5 sm:px-6 min-h-24 bg-gradient-to-t from-red-800 to-rose-800 static">
